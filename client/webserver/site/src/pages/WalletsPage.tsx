        ...
        return (
          ...
          >
            ...
            {/* Row reads as: tree → blockchain glyph → chain name →
                ...
                doesn't, because the preserveAspectRatio letterbox
                lets the left chain bleed into the visible viewport);
                the translate + rotate position the clipped result. */}
            <svg
              width="20"
              height="20"
              viewBox="0 0 128 128"
              ...
              style={{
                ...
                transform: 'translate(-25%, -15%) rotate(35deg)',
              }}
            >
